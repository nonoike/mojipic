...
class TwitterAuthenticator @Inject()(
  ...
  private[this] val CacheKeyPrefixTwitter = "twitterInstance"
  private[this] val ConsumerKey = configuration.get[String]("mojipic.consumerkey")
  private[this] val ConsumerSecret = configuration.get[String]("mojipic.consumersecret")
  ...
  def getAccessToken(sessionId: String, verifier: String): AccessToken =
    try {
      ...
      case NonFatal(e) => throw TwitterException(s"Could not get an access token. SessionId: $sessionId", e)
    }
}
